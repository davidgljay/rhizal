...
`;
    ...
    describe('send', () => {
        it('should throw an error if the script is not initialized', () => {
            const parser = new RhyzalParser('stuff and things', send_message, send_attachment, set_user_variable);
            expect(() => parser.send(0, {})).toThrow('Script not initialized');
        });

        it('should throw an error if the step is missing from the script', () => {
            const parser = new RhyzalParser(test_yaml, send_message, send_attachment, set_user_variable);
        ...
        it('should send the appropriate message', () => {
            ...
            expect(send_attachment).toHaveBeenCalledWith('filevar');
        });
        ...
        it ('should send the appropriate message with variables', () => {
            ...
            const parser = new RhyzalParser(test_yaml, send_message, send_attachment, set_user_variable);
            parser.send(0, vars, send_message, send_attachment);
    ...
    describe ('receive', () => {
        ...
        it('should send the appropriate message based on the new status', () => {
            ...
            parser.receive(0, {user_id: 1, var1: 'foo'}, set_user_variable, send_message, send_attachment);
